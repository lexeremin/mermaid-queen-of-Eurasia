...
| `cobble_atlas.png` | Generated by `tools/make-tiles.py` from `tools/palette.json`, 2026-09-25 | Original work, project licence | yes | 128×128 atlas of four 64×64 paving variants (irregular worn cobbles, moss in the grout). The ground autotiler picks one per 4 m block. Replaces `cobble_tile.png`. |

...
| `npc_mikhalych.glb` | Procedural, `tools/blender/build_npcs.py` (`build_mikhalych`), 2026-09-24 | Original work, project licence | yes | Fictional archetype, no real person depicted. Kvass vendor with mug. |
...
| `enemy_wisp.glb` | Procedural, `tools/blender/build_enemies.py` (`build_wisp`), 2026-09-24 | Original work, project licence | yes | Fictional absurd bureaucratic monster, resembles no real person. Paper Wisp: swirl of forms with a stamped face. |
| `enemy_stamper.glb` | Procedural, `tools/blender/build_enemies.py` (`build_stamper`), 2026-09-24 | Original work, project licence | yes | Fictional absurd bureaucratic monster, resembles no real person. Stamp Golem: filing cabinets with a giant stamp fist. |
| `enemy_memo.glb` | Procedural, `tools/blender/build_enemies.py` (`build_memo`), 2026-09-24 | Original work, project licence | yes | Fictional absurd bureaucratic monster, resembles no real person. Memo Thrower: clerk with a paper-airplane hat. |
...
| `grass_tile.png` | Generated by `tools/make-tiles.py` from `tools/palette.json`, 2026-09-24 | Original work, project licence | yes | 32×32 tiling grass speckle, palette colors, used on lawns and the outer ground. |
| `cobble_tile.png` | Generated by `tools/make-tiles.py` from `tools/palette.json`, 2026-09-24 | Original work, project licence | yes | 32×32 tiling wet cobblestone, palette colors, used on the plaza ground. |

...
| `prop_monument.glb` | Procedural, `tools/blender/build_zaryadye_assets.py` (`build_monument`), 2026-09-25 | Original work, project licence | yes | Two heroes on a plinth (a standing swordsman and a kneeling man with a bowl), bronze-green, in front of Saint Basil's: a stylized impression of a 1612 monument, no likeness of anyone. |
| `prop_lobnoe.glb` | Procedural, `tools/blender/build_zaryadye_assets.py` (`build_lobnoe`), 2026-09-25 | Original work, project licence | yes | The round stone platform (Lobnoye Mesto) in front of Saint Basil's. |
| `prop_rail.glb` | Procedural, `tools/blender/build_zaryadye_assets.py` (`build_rail`), 2026-09-25 | Original work, project licence | yes | 3 m embankment railing section. |
| `bld_amphitheatre.glb` | Procedural, `tools/blender/build_zaryadye_assets.py` (`build_amphitheatre`), 2026-09-25 | Original work, project licence | yes | Stepped half-round amphitheatre with a stage and a stone backdrop (Zaryadye Park). |
| `bld_chapel.glb` | Procedural, `tools/blender/build_zaryadye_assets.py` (`build_chapel`), 2026-09-25 | Original work, project licence | yes | Small whitewashed chapel with a green onion dome, apse and bell gable (Varvarka style). |
| `npc_vanya.glb` | Procedural, `tools/blender/build_locals.py` (`build_vanya`), 2026-09-25 | Original work, project licence | yes | Generic local: the tracksuit guy squatting with sunflower seeds. Fictional archetype, no real person. |
| `npc_babushka.glb` | Procedural, `tools/blender/build_locals.py` (`build_babushka`), 2026-09-25 | Original work, project licence | yes | Generic local: a grandmother with a flowery headscarf and two shopping bags. Fictional archetype. |
| `npc_tourist.glb` | Procedural, `tools/blender/build_locals.py` (`build_tourist`), 2026-09-25 | Original work, project licence | yes | Generic local: a tourist with a selfie stick. Fictional archetype. |
| `npc_painter.glb` | Procedural, `tools/blender/build_locals.py` (`build_painter`), 2026-09-25 | Original work, project licence | yes | Generic local: a street painter at an easel. Fictional archetype. |
| `npc_kvass.glb` | Procedural, `tools/blender/build_locals.py` (`build_kvass`), 2026-09-25 | Original work, project licence | yes | Generic local: a kvass seller with her barrel. Fictional archetype. |
| `npc_sentry.glb` | Procedural, `tools/blender/build_locals.py` (`build_sentry`), 2026-09-25 | Original work, project licence | yes | Generic local: a ceremonial sentry in a tall hat. Fictional archetype, not any real unit. |
| `npc_kid.glb` | Procedural, `tools/blender/build_locals.py` (`build_kid`), 2026-09-25 | Original work, project licence | yes | Generic local: a child with a balloon and a pigeon. Fictional archetype. |
| `boss_lobbyist.glb` | Procedural, `tools/blender/build_bosses.py` (`build_lobbyist`), 2026-09-25 | Original work, project licence | yes | Underground boss: the Lobbyist, a pinstripe suit, monocle and an open briefcase of banknotes. Original satirical archetype (a corporate cliché, no nationality, no real person). Rigid parts, `idle` clip, `arm_stamp`. |
| `boss_senator.glb` | Procedural, `tools/blender/build_bosses.py` (`build_senator`), 2026-09-25 | Original work, project licence | yes | Underground boss: Senator Endless, a round man with a sash, scroll and megaphone. Original satirical archetype, no real person. |
| `boss_baron.glb` | Procedural, `tools/blender/build_bosses.py` (`build_baron`), 2026-09-25 | Original work, project licence | yes | Underground boss: the Yacht Baron, fur coat, chains, sunglasses, captain’s hat and a golden anchor. Original satirical archetype, no real person. |
| `boss_spin.glb` | Procedural, `tools/blender/build_bosses.py` (`build_spin`), 2026-09-25 | Original work, project licence | yes | Underground boss: the Spin Doctor, a teal suit, spiral tie, pinwheel cap and a giant microphone. Original satirical archetype, no real person. |
...
| `npc_michael.glb` | Procedural, `tools/blender/build_archangels.py` (`build_michael`), 2026-09-25 | Original work, project licence | yes | Fictional child character, one of the three archangels (id `michael`): a small winged boy with a halo, blue tunic, wooden sword and shield. Rigid parts with `idle` and `happy` clips. |
| `npc_gabriel.glb` | Procedural, `tools/blender/build_archangels.py` (`build_gabriel`), 2026-09-25 | Original work, project licence | yes | Fictional child character, one of the three archangels (id `gabriel`): a small winged boy with a halo, ivory robe, little trumpet and a lily. Rigid parts with `idle` and `happy` clips. |
| `npc_serafima.glb` | Procedural, `tools/blender/build_archangels.py` (`build_serafima`), 2026-09-25 | Original work, project licence | yes | Fictional child character, one of the three archangels (id `serafima`): a small winged girl with a halo, rose robe, three pairs of wings and a small flame. Rigid parts with `idle` and `happy` clips. |

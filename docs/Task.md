...
| Phase 15b — Environment polish | ✅ Complete | GUM flicker fixed at the source (coplanar faces), richer ground tiles with mipmapped filtering, plaza kerbs, contact shadows, GUM roof hides indoors | HASH15B |

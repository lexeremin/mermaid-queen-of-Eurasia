...
| Phase 26 — Skills and sixty levels | ✅ Complete | Abilities unlock one by one (Trident 1, Aura 3, Blink 6, Surge 10), level cap 60, passives every tenth level (sea wave 20, Aura light beams 30, Surge sharks 40, Blink arcane blast 50), holy wings and halo at 60, a much steeper dungeon, richer Surge visuals, softer noise | |

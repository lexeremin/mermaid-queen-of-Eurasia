...
**Phase 26 complete (skills and sixty levels).** Next: **Phase 27 — Real-device QA** (`docs/phases/phase-27.md` — write it first, it does not exist yet).
...
3. Read `docs/phases/phase-27.md` for the specific task. If the doc for the current phase does not exist yet, write it first (goal, scope, steps, DoD) and add it to the commit.
...
| Phase 27 — Real-device QA | ⬜ Next | iPhone Safari pass, budgets, fixes | |
| Phase 28 — Deploy | ⬜ Todo | Hosting (Cloudflare Pages or Vercel), env config, release | |

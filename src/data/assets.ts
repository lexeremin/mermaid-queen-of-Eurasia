...
export const ASSETS = {
  ...
  npcArkady: { url: '/assets/npc/npc_arkady.glb', clips: [] },
  npcKolya: { url: '/assets/npc/npc_kolya.glb', clips: [] },
  npcMichael: { url: '/assets/npc/npc_michael.glb', clips: ['idle', 'happy'] },
  npcGabriel: { url: '/assets/npc/npc_gabriel.glb', clips: ['idle', 'happy'] },
  npcSerafima: { url: '/assets/npc/npc_serafima.glb', clips: ['idle', 'happy'] },
  enemyTycoon: { url: '/assets/enemy/enemy_tycoon.glb', clips: [] },
  enemySpeaker: { url: '/assets/enemy/enemy_speaker.glb', clips: [] },
  enemyDemagogue: { url: '/assets/enemy/enemy_demagogue.glb', clips: [] },
